...
@Component({
  selector: 'app-uppercase-italic-list',
  standalone: true,
  templateUrl: './uppercase-italic-list.component.html',
  styleUrls: ['./uppercase-italic-list.component.css'],
  imports: [FormsModule, CommonModule], // Add FormsModule and CommonModule here
})
export class UppercaseItalicListComponent {
